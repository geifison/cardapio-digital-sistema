...
import { Trash2, Pencil, MoreHorizontal, Plus, Pizza } from "lucide-react";
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <div className="flex items-center gap-2">
                          ...
                          {(p as any).product_type === "pizza" && (
                            <div className="flex items-center gap-1 px-2 py-0.5 bg-orange-100 text-orange-700 text-xs rounded-full">
