      ...
      <Tabs value={activeTab} onValueChange={(v) => setActiveTab(v as "sizes" | "flavors" | "borders" | "extras")}>
        ...
        <TabsContent value="flavors" className="mt-4">
          <div className="flex items-center gap-4 mb-2">
            ...
            <Button onClick={() => { setEditingFlavor(null); resetFlavorForm(); setOpenFlavor(true); }} className="ml-auto">
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead>Valor da Categoria</TableHead>
              ...
              <TableBody>
                {flavorsFiltered.length === 0 ? (
                  <TableRow><TableCell colSpan={8} className="py-8 text-center text-muted-foreground">Nenhum sabor</TableCell></TableRow>
                  ...
                  <TableRow key={f.id}>
                    ...
                    <TableCell className="max-w-xs">
                      <div className="truncate" title={f.ingredients || '-'}>
                        {f.ingredients || '-'}
                      </div>
                    </TableCell>
